...
var grade = (score > 100 && score < 0) ? "Your marks cannot be less than O or more than 100" : (score <= 59 && score >= 0) ?"Grade F" : 
(score <= 69 && score >= 60) ? "Grade D" : (score <= 79 && score >= 70) ? "Grade C" : (score <= 89 && score >= 80) ? "Grade B" : (score <= 100 && score >= 90) ? "Grade A" : "You have entered an Invalid MArk"
console.log(grade);